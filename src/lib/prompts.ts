...
export const prompt = `Write a weekly check-in message for your accountability friends. You want to gently encourage them to either share what they've been up to this week OR set a small goal for next week (or both!).
